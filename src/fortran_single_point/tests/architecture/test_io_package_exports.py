...
class InputOutputPackageExportTests(unittest.TestCase):
    def test_input_package_exports_its_implementation_objects(self) -> None:
        implementation = importlib.import_module(
            "fortran_single_point.Input.parsec_input"
        )
        package = importlib.import_module("fortran_single_point.Input")
    ...
    def test_output_package_exports_its_implementation_objects(self) -> None:
        implementation = importlib.import_module(
            "fortran_single_point.Output.parsec_output"
        )
        package = importlib.import_module("fortran_single_point.Output")
