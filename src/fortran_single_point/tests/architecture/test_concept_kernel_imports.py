...
import fortran_single_point as public_api
from fortran_single_point.Energy import total_energy
from fortran_single_point.Grid import RealSpaceGrid, build_cluster_grid
from fortran_single_point.Hamiltonian import KohnShamHamiltonian
from fortran_single_point.Hartree import solve_hartree
from fortran_single_point.Laplacian import (
    apply_negative_laplacian_boundary,
    build_negative_laplacian,
    neighbor_shells,
    second_derivative_coefficients,
)
from fortran_single_point.Mixer import (
    AndersonMixer,
    ResidualMetrics,
    potential_residual_metrics,
)
from fortran_single_point.Occupations import (
    BOLTZMANN_RYDBERG_PER_KELVIN,
    OccupationResult,
    density_from_orbitals,
    fermi_occupations,
)
from fortran_single_point.Pseudopotential import (
    ParsecRadialSpline,
    parsec_radial_integral,
    read_parsec_pseudopotential,
)
from fortran_single_point.V_ion import build_nonlocal_projectors
from fortran_single_point.V_xc import XCResult, ca_lda
...
class ConceptKernelImportTests(unittest.TestCase):
    def test_grid_and_laplacian_public_api_uses_concept_implementations(
        ...
        self.assertEqual(
            ...
            "fortran_single_point.Laplacian.finite_difference",
        )
