...
from legacy_python.rsdft_backend import select_solver_backend
from legacy_python.rsdft_input import has_diagmeth_override, load_elements, prepare_input_data
from legacy_python.rsdft_models import SolverSettings
from legacy_python.rsdft_output import (
    initialize_output_file,
    print_radius_selection,
    write_rsdft_parameter_output,
)
from legacy_python.rsdft_setup import prepare_system
from legacy_python.rsdft_solver import run_rsdft_calculation


def _parse_cli_args(argv: list[str]) -> argparse.Namespace:
    """Parse the optional input path and forced backend selection."""
    parser = argparse.ArgumentParser(
        description="Run the refactored legacy RSDFT driver."
    )
