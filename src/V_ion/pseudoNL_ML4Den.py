...
def pseudoNL_ML4Den(Domain, Atoms, elem, N_elements):
    """
    ...
    for at_typ in range(N_types):
        ...
        for at in range(natoms):
            ...
            i0 = int(round(xxa / h + 1))
            j0 = int(round(yya / h + 1))
            k0 = int(round(zza / h + 1))
            # i0 = max(1, min(nx, i0))
            # j0 = max(1, min(ny, j0))
            # k0 = max(1, min(nz, k0))
...
def pseudoNL_vectorized_ML4Den(Domain, Atoms, elem, N_elements):
    """
    ...
    for at_typ in range(N_types):
        ...
        for at in range(xyz.shape[0]):
            ...
            # Calculate positions
            i0 = int(round(atom_pos[0] / h + 1))
            j0 = int(round(atom_pos[1] / h + 1))
            k0 = int(round(atom_pos[2] / h + 1))
            ...
            xxx = (i_coords - 1) * h - atom_pos[0]
            yyy = (j_coords - 1) * h - atom_pos[1]
            zzz = (k_coords - 1) * h - atom_pos[2]
