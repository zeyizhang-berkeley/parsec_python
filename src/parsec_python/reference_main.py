"""Opt-in launcher for the readable SciPy reference implementation.

Normal calculations should use :mod:`parsec_python.main`, whose automatic
backend policy selects the fastest accuracy-preserving implementation.
"""
...
from parsec_python.cli import main  # noqa: E402
